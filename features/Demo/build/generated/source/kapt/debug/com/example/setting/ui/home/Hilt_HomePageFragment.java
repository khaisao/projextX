 ...
 */
public abstract class Hilt_HomePageFragment<BD extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<BD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomePageFragment_GeneratedInjector) this.generatedComponent()).injectHomePageFragment(UnsafeCasts.<HomePageFragment>unsafeCast(this));
    }
  }
